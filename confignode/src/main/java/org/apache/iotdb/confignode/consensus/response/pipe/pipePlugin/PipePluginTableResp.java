package org.apache.iotdb.confignode.consensus.response.pipe.pipePlugin;
...
public class PipePluginTableResp implements DataSet {
  ...
  public PipePluginTableResp(TSStatus status, List<PipePluginInformation> allPipePluginInformation) {
    this.status = status;
